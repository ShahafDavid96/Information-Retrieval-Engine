...
from search_backend import SearchHandler
...
def search():
    ...
    if len(query) == 0:
      return jsonify(res)
    #BEGIN SOLUTION
    res=search_handler.search(query)
...
def search_body():
    ...
    if len(query) == 0:
      return jsonify(res)
    # BEGIN SOLUTION
    res = search_handler.search_body(query)
    # END SOLUTION
    return jsonify(res)
...
def search_title():
    ...
    if len(query) == 0:
      return jsonify(res)
    # BEGIN SOLUTION
    res=search_handler.search_title(query)
    # END SOLUTION
    return jsonify(res)
...
def search_anchor():
    ...
    res=search_handler.search_anchor(query)
    # END SOLUTION
    return jsonify(res)
...
def get_pagerank():
    ...
    if len(wiki_ids) == 0:
      return jsonify(res)
    # BEGIN SOLUTION
    res=search_handler.get_page_rank(wiki_ids)
    # END SOLUTION
    return jsonify(res)
...
def get_pageview():
    ...
    if len(wiki_ids) == 0:
      return jsonify(res)
    # BEGIN SOLUTION
    res=search_handler.get_page_view(wiki_ids)
    # END SOLUTION
    return jsonify(res)
